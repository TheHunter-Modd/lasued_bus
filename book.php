            ...
            <div class="col-md-6 col-lg-5">
                <div class="card shadow p-4 rounded-4">
                    <form action="book.php" method="post" class="row g-3">
                        ...
                        <div class="col-12">
                            <label for="seat_number" class="form-label fw-semibold">Seat Number (1–50)</label>
                            <input type="number" name="seat_number" id="seat_number" class="form-control" min="1" max="50" required>
                        </div>
